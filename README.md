...
- `images/` — fotos dos produtos, enviadas pelo próprio painel.

Repositório: https://github.com/atelie-lua/atelieLua · Site: https://atelie-lua.github.io/atelieLua/
...
1. No GitHub, vá em **Settings → Pages**, selecione a branch `main` e a pasta `/ (root)`, salve.
2. Confirme que o repositório está público (Settings → General → Danger Zone → Change visibility).
3. Depois de alguns minutos o site estará em `https://atelie-lua.github.io/atelieLua/`.
...
3. Em "Repository access", selecione **Only select repositories** e escolha só o `atelieLua`.
...
6. Se precisar revogar o acesso de alguém, revogue esse token e gere um novo pra quem continuar editando.

### Usando o painel

1. Abra `https://atelie-lua.github.io/atelieLua/admin.html`.
